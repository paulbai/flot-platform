                      ...
                      <div className="mb-6 p-4 rounded-2xl border-2 border-[#80F0C0]/30 bg-[#80F0C0]/10">
                        <div className="flex items-start gap-3 mb-3">
                          ...
                          <div className="text-left">
                            <p className="text-sm font-bold text-gray-900">Get the Flot App</p>
                            <p className="text-xs text-gray-500 mt-0.5">
                              Download Flot for a seamless banking experience — instant payments, transaction tracking, and one-tap checkout.
                            </p>
                          </div>
                        </div>
                        <div className="flex gap-2">
                          <a
                            ...
                            className="flex-1 py-2.5 rounded-xl text-sm font-bold text-white bg-gray-900 hover:bg-gray-800 transition-colors flex items-center justify-center gap-1.5"
                          >
                        ...
                        <button
                          ...
                          className="w-full mt-2 py-2 text-xs font-medium text-gray-400 hover:text-gray-600 transition-colors"
                        >
                          Maybe later
                        </button>
                      </div>
